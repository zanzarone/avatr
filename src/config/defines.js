...
export const BackgroundClasses = {
  ...
  BG2: { style: "bg-2", value: "BG 2", path: "BG2" },
  BG3: { style: "bg-3", value: "BG 3", path: "BG3" },
  BG4: { style: "bg-4", value: "BG 4", path: "BG4" },
  BG5: { style: "bg-5", value: "BG 5", path: "BG5" },
  BG6: { style: "bg-6", value: "BG 6", path: "BG6" },
  BG_CLEAR: { style: "bg-clear", value: "BG clear" },
  BG_7: { style: "bg-7", value: "BG 7", path: "BG7" },
};
...
export const EarsClasses = {
  EA1: { path: "EA1", value: "Type EA1" },
  EA2: { path: "EA2", value: "Type EA2" },
};

export const AccessoriesClasses = {
  GLASSES: {
    KEY: "GLASSES",
    COLORS: {
